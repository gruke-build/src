...
namespace Nuke.Common.Components.Forgejo.User.Times
{
    ...
    public partial class TimesRequestBuilder : BaseRequestBuilder
    {
        ...
        public TimesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/user/times{?before*,limit*,page*,since*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Nuke.Common.Components.Forgejo.User.Times.TimesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TimesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/user/times{?before*,limit*,page*,since*}", rawUrl)
        {
        }
        /// <summary>
