...
using System;
namespace Nuke.Components.Forgejo.User.Actions.Runners.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \user\actions\runners\{runner_id}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithRunner_ItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Nuke.Components.Forgejo.User.Actions.Runners.Item.WithRunner_ItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithRunner_ItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/user/actions/runners/{runner_id}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Nuke.Components.Forgejo.User.Actions.Runners.Item.WithRunner_ItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithRunner_ItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/user/actions/runners/{runner_id}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Nuke.Components.Forgejo.User.Actions.Runners.Item.WithRunner_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Nuke.Components.Forgejo.User.Actions.Runners.Item.WithRunner_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
