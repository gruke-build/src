...
using System;
namespace Nuke.Components.Forgejo.Repos.Item.Item.Tags.Item
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Nuke.Components.Forgejo.Repos.Item.Item.Tags.Item.WithTagItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Nuke.Components.Forgejo.Models.Tag?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Nuke.Components.Forgejo.Models.Tag> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Nuke.Components.Forgejo.Repos.Item.Item.Tags.Item.WithTagItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Nuke.Components.Forgejo.Repos.Item.Item.Tags.Item.WithTagItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
