...
using System;
namespace Nuke.Common.Components.Forgejo.Repos.Item.Item.Generate
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Nuke.Common.Components.Forgejo.Repos.Item.Item.Generate.GenerateRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="body">GenerateRepoOption options when creating repository using a template</param>
...
#nullable enable
        public async Task<global::Nuke.Common.Components.Forgejo.Models.Repository?> PostAsync(global::Nuke.Common.Components.Forgejo.Models.GenerateRepoOption body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Nuke.Common.Components.Forgejo.Models.Repository> PostAsync(global::Nuke.Common.Components.Forgejo.Models.GenerateRepoOption body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Nuke.Common.Components.Forgejo.Models.GenerateRepoOption body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Nuke.Common.Components.Forgejo.Models.GenerateRepoOption body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Nuke.Common.Components.Forgejo.Repos.Item.Item.Generate.GenerateRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Nuke.Common.Components.Forgejo.Repos.Item.Item.Generate.GenerateRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Nuke.Common.Components.Forgejo.Repos.Item.Item.Generate.GenerateRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
