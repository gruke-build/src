...
namespace Nuke.Common.Components.Forgejo.Repos.Item.Item.Pulls.Item.Update
{
    ...
    public partial class UpdateRequestBuilder : BaseRequestBuilder
    {
        ...
        public UpdateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner%2Did}/{repo%2Did}/pulls/{base%2Did}/update{?style*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Nuke.Common.Components.Forgejo.Repos.Item.Item.Pulls.Item.Update.UpdateRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UpdateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner%2Did}/{repo%2Did}/pulls/{base%2Did}/update{?style*}", rawUrl)
        {
        }
        /// <summary>
