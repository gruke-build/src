...
namespace Nuke.Components.Forgejo.Repos.Item.Item.Issues.Item.Subscriptions.Check
{
    ...
    public partial class CheckRequestBuilder : BaseRequestBuilder
    {
        ...
        public CheckRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner%2Did}/{repo%2Did}/issues/{index}/subscriptions/check", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Nuke.Components.Forgejo.Repos.Item.Item.Issues.Item.Subscriptions.Check.CheckRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CheckRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/repos/{owner%2Did}/{repo%2Did}/issues/{index}/subscriptions/check", rawUrl)
        {
        }
        /// <summary>
