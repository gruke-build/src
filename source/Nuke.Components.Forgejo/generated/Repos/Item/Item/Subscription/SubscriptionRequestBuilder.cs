...
using System;
namespace Nuke.Components.Forgejo.Repos.Item.Item.Subscription
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Nuke.Components.Forgejo.Repos.Item.Item.Subscription.SubscriptionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public async Task<global::Nuke.Components.Forgejo.Models.WatchInfo> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Nuke.Components.Forgejo.Models.WatchInfo>(requestInfo, global::Nuke.Components.Forgejo.Models.WatchInfo.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Watch a repo
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Nuke.Components.Forgejo.Models.WatchInfo?> PutAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Nuke.Components.Forgejo.Models.WatchInfo> PutAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Nuke.Components.Forgejo.Repos.Item.Item.Subscription.SubscriptionRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Nuke.Components.Forgejo.Repos.Item.Item.Subscription.SubscriptionRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Nuke.Components.Forgejo.Repos.Item.Item.Subscription.SubscriptionRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
