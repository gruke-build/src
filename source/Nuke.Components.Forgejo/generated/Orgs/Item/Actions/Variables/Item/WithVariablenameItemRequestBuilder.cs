...
namespace Nuke.Components.Forgejo.Orgs.Item.Actions.Variables.Item
{
    ...
    public partial class WithVariablenameItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithVariablenameItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/actions/variables/{variablename}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Nuke.Components.Forgejo.Orgs.Item.Actions.Variables.Item.WithVariablenameItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithVariablenameItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/actions/variables/{variablename}", rawUrl)
        {
        }
        /// <summary>
