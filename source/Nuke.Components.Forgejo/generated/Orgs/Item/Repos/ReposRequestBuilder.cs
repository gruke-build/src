...
using System;
namespace Nuke.Components.Forgejo.Orgs.Item.Repos
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Nuke.Components.Forgejo.Orgs.Item.Repos.ReposRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::Nuke.Components.Forgejo.Models.Repository>?> GetAsync(Action<RequestConfiguration<global::Nuke.Components.Forgejo.Orgs.Item.Repos.ReposRequestBuilder.ReposRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Nuke.Components.Forgejo.Models.Repository>> GetAsync(Action<RequestConfiguration<global::Nuke.Components.Forgejo.Orgs.Item.Repos.ReposRequestBuilder.ReposRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Nuke.Components.Forgejo.Orgs.Item.Repos.ReposRequestBuilder.ReposRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Nuke.Components.Forgejo.Orgs.Item.Repos.ReposRequestBuilder.ReposRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Nuke.Components.Forgejo.Orgs.Item.Repos.ReposRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Nuke.Components.Forgejo.Orgs.Item.Repos.ReposRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Nuke.Components.Forgejo.Orgs.Item.Repos.ReposRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// List an organization&apos;s repos
        /// </summary>
