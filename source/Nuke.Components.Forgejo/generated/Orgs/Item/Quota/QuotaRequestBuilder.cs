...
namespace Nuke.Common.Components.Forgejo.Orgs.Item.Quota
{
    ...
    public partial class QuotaRequestBuilder : BaseRequestBuilder
    {
        ...
        public QuotaRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/quota", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Nuke.Common.Components.Forgejo.Orgs.Item.Quota.QuotaRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public QuotaRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/quota", rawUrl)
        {
        }
        /// <summary>
